...
const helpImages = [
    "https://imgur.com/a/7jQzdUU.jpeg",
    "https://imgur.com/a/F6EIWDG.jpeg",
    "https://imgur.com/a/lS2s55D.jpeg",
    "https://imgur.com/a/RdKFVdL.jpeg"
];
...
module.exports.handleEvent = function ({ api, event, getText }) {
    ...
    const detail = getText("moduleInfo",  
        ...
        prefix,  
        global.config.BOTNAME || "Mahu The Chat Bot"  
    );  
...
module.exports.run = function ({ api, event, args, getText }) {
    ...
    if (args[0] && commands.has(args[0].toLowerCase())) {  
        ...
        const detailText = getText("moduleInfo",  
            ...
            command.config.cooldowns || 0,  
            prefix,  
            global.config.BOTNAME || "Mahu 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭"  
        );  
...
┣━━━━━━━━━━━━━━━━┫
┃ ⚙ Prefix: ${prefix}
┃ 🤖 Bot Name: ${global.config.BOTNAME || "Mahu The Chat Bot"}
┃ 👑 Owner: Mahu
╰━━━━━━━━━━━━━━━━╯`;
